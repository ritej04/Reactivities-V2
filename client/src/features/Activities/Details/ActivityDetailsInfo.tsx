    ...
    return (
        <Paper sx={{ mb: 2 }}>
            ...
            <Grid container sx={{ alignItems: "center", pl: 2, py: 1 }}>
                ...
                <Grid size={11} sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <Typography>
                        {activity.venue},{activity.city}
                    </Typography>
                    <Button sx={{whiteSpace:'nowrap',mx:2}}onClick={()=>setMapOpen(!mapOpen)} >{mapOpen?'Hide Map':'Show Map'}</Button>
                </Grid>
            </Grid>
