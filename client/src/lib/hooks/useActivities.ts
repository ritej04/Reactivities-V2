...
export const useActivities = (id? : string) => {
    ...
    const updateAttendance = useMutation({
        ...
        onError: (error,activityId,context) => {
            console.log('preActivity' +context?.prevActivity);
            console.log(error);
    ...
    return { isFetchingNextPage,fetchNextPage,hasNextPage
        ,activitiesGroup, isLoading, updateActivity 
        ,createActivity, deleteActivity,activity
        ,isLoadingActivity,updateAttendance};  
}